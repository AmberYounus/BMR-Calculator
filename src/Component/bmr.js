...
Woman BMR = 655.1 + ( 4.35 × weight in pounds ) + ( 4.7 × height in inches ) - ( 4.7 × age in years )
    ...
    render() {
        ...
        let error;                 //condition rendering
        if(this.state.error){ 
            error=<div className="error">{this.state.error}</div>
        }
        let resultBMR;                 //condition rendering
        if(this.state.bmr){ 
            ...
            <div>
                ...
                <div className="form">
                    ...
                    <div className="inputwrap">
                        ...
                        <input type="radio" value={this.state.gender}  checked={this.state.gender === '1'} onChange={this.handleGenderChange } className="genderF" name="gender" value="1" />Female</label><label>
                            <input type="radio" value={this.state.gender} checked={this.state.gender === '2'}onChange={this.handleGenderChange } className="genderM" name="gender" value="2" />Male</label>
                    </div>
                    <div className="inputwrap">
